  ...
  return (
    <div className="rules-container">
      ...
      <p className="indented-paragraph">
        ...
        mapy a cestou nakrmit příšerku, aby vyrostla. Klikni na příšerku a
        odpověz na otázku. Příšerka dostane jídlo pokaždé, když odpovíš správně,
        ale pozor – potraviny, které máš pro příšerku připravené, ti ubývají i
        když odpovíš špatně! Může se tedy stát, že ti dojdou potraviny a nebudeš
        mít čím příšerku nakrmit, a hra tak pro tebe skončí.
      </p>
      <p className="indented-paragraph">
